...
public class Tests(ITestOutputHelper output)
{
    ...
    public static IEnumerable<object[]> GetTestData() => [
        ...
        [new TestData(  4, null, typeof(ListImageByType),                "List", "Image",    "Type=1",   "Name=abc")],
        [new TestData(  5, null, typeof(ListImageByType),                "L",    "Ima",      "T=1",      "N=abc" )],
        [new TestData(  6, "TypeId must be between 1 and 9",     null,   "List", "Image",    "Type=0",   "N=abc" )],
        [new TestData(  7, null, typeof(ListImageByNamespace),           "List", "Image",    "--Namespace=abc")],
        [new TestData(  8, null, typeof(ListImageByNamespace),           "List", "Ima",      "--Names=abc")],
        [new TestData(  9, "Ambiguous command",                  null,   "List", "Ima",      "Name=abc")],
        [new TestData( 10, "abbreviation is ambiguous",          null,   "List", "Ima",      "N=abc")],
        [new TestData( 11, null, typeof(ListImport),                     "List", "Import")],
        [new TestData( 12, null, typeof(ListImport),                     "List", "Imp")],
        [new TestData( 13, "Ambiguous command",                  null,   "L", "I")],
        [new TestData( 14, null, typeof(Cleanup),                        "Cleanup")],
    ];
